                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="dashboard-nav">
                            <ul class="list-inline">
                                <li class="list-inline-item"><a href="billing-information.html">Billing
                                        information</a>
                                    <i class="fas fa-angle-right"></i>
                                </li>
                                <li class="list-inline-item"><a href="shipping.html">Shipping</a> <i
                                        class="fas fa-angle-right"></i></li>
                                <li class="list-inline-item"><a href="payment.html" class="mr-0 active">Payment</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="payment-info">
                                    <div
                                        ...
                                        <div class="credit-card">
                                            <a href="#">
                                                <svg id="masterclass" xmlns="http://www.w3.org/2000/svg"
                                                    width="18.219" height="14.22" viewBox="0 0 18.219 14.22">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form__div">
                                                <input type="text" class="form__input"
                                                    placeholder="
                                                ">
                                                <label for="" class="form__label">Expiration Date (MM /
                                                    YY)</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
