                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2">
                        <div class="banner-area__img">
                            <img src="{{ asset('images/banner.jpg') }}" alt="banner-img" class="img-fluid">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="features-active">
                        <div class="product-item">
                            <div class="product-item-image">
                                <a href=""><img src="{{ asset('images/product/05.jpg') }}" alt="Product Name"
                                        class="img-fluid"></a>
                                <div class="cart-icon">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="product-item">
                            ...
                            <div class="product-item-info">
                                <a href="{{ route('product-details') }}">Fossil Men's Nate Stainless Steel Chronograph
                                    Quartz
                                    Watch</a>
                                <span>$175</span> <del>$199</del>
                            </div>
