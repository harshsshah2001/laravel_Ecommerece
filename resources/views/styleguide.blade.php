...
<body>
    <div class="container">
                                        ...
                                        <a href="cart.html"><svg xmlns="http://www.w3.org/2000/svg" width="22"
                                                ...
                                                <g id="Icon" transform="translate(-1524 -89)">
                                                    ...
                                                    <path id="Path_3" data-name="Path 3"
                                                        ...
                                                        transform="translate(1524 89)" fill="none"
                                                        stroke="#1a2224" stroke-linecap="round"
                                                        stroke-linejoin="round" stroke-width="2" />
                                                </g>
                                            </svg>
                            ...
                            <div class="search-bar">
                                ...
                                <div class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20.414" height="20.414"
                                        viewBox="0 0 20.414 20.414">
                                        <g id="Search_Icon" data-name="Search Icon" transform="translate(1 1)">
                                            <ellipse id="Ellipse_1" data-name="Ellipse 1" cx="8.158"
                                                cy="8" rx="8.158" ry="8" fill="none"
        ...
        <h2 class="pt-5">Button</h2>
        <hr>
        <div class="bg-black py-5">
            <a class="btn bg-primary" href="#">Continue</a> <code>.btn .bg-primary</code>
            <a class="btn bg-secondary border text-capitalize" href="#">Subscribe</a> <code>.btn .bg-secondary
                .text-capitalize</code>
        </div>
        <h2 class="py-5">Language/currency Switcher</h2>
        <hr>
        <div class=" d-flex align-items-center justify-content-between">
            <div> <select>
                    <option data-display="English">Bangla</option>
                    <option value="1">Arabic</option>
                    <option value="2">Aramaic</option>
        ...
        <h2 class="py-5">Form Input Material Design</h2>
        <hr>
        <div class="l-form">
        ...
        <h2 class="py-5">Prodact Item</h2>
        <hr>
        <div class="row">
            <div class="col-3">
                <div class="productcategory text-center">
                    <div class="productcategory-img">
                        <img src="dist/images/categorys/jumper.jpg" alt="images">
                    </div>
        ...
        <h1 class="mb-3 py-5 text-warning text-center">BreadCrumb</h1>
        <!-- BreadCrumb -->
                ...
                <div class="col-lg-4">
                    <div class="product-item">
                        <div class="product-item-image">
                            <img src="dist/images/product/05.jpg" alt="Product Name" class="img-fluid">
                            <div class="cart-icon">
                        ...
                        <div class="product-item-info">
                            <a href="#">BERRY TYPE-II: C1N Backpack</a>
                    ...
                    <div class="body">
                                            ...
                                            <a href="javascript:void(0)" class="minus">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="11.98" height="6.69"
                                                    ...
                                                    <path id="Arrow" d="M1474.286,26.4l5,5,5-5"
                                                        ...
                                                        stroke="#989ba7" stroke-linecap="round"
                        ...
                        <div class="item">
                            ...
                            <div class="name">
                                ...
                                <div class="button">
                                    <a class="btn bg-primary" href="#">Checkout now</a>
                                    <a class="cart-btn" href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="18"
                                            viewBox="0 0 20 18">
                                            <g id="Heart" transform="translate(1 1)">
