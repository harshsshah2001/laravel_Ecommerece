...
//for address form
Route::get('Address_Form', [RazorpayPaymentController::class, 'address_form_function'])->name('address_form');
Route::post('Address_Form', [RazorpayPaymentController::class, 'saveaddress_function'])->name('address_form_submit');
